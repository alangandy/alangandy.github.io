...
## Application Terms Used in Navigation
**Workflows** Synonymous with *form* or *interview*. Since this application can be used for different document automation processes, these general terms are used by the vendor to describe the online forms used to gather data.
